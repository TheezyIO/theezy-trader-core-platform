...
def main(args):
    ...
    if not validate_all_fields(field_validation_list, args):
        return {'statusCode': 400,
                'body': {'message': 'Missing or invalid parameters'}}

    if args['amount'] <= 0:
        return {'statusCode': 400,
                'body': {'message': 'Deposit amount must be greater than 0'}}
    ...
    try:
        ...
        transaction_body = {
            ...
            # TODO: Add Transaction Table DAO for dynamic id lookup
        ...
        account_dao.update_balance({'cash': new_balance}, account_record['id'])
